...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, CreditCard, Calendar
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  // Define sidebar items based on user role with integrated calendar & payments/wallet links
  const entrepreneurItems = [
    { to: '/dashboard/entrepreneur', icon: <Home size={20} />, text: 'Dashboard' },
    { to: '/profile/entrepreneur/' + user.id, icon: <Building2 size={20} />, text: 'My Startup' },
    { to: '/investors', icon: <CircleDollarSign size={20} />, text: 'Find Investors' },
    { to: '/calendar', icon: <Calendar size={20} />, text: 'Scheduling Calendar' },
    { to: '/payments', icon: <CreditCard size={20} />, text: 'Wallet & Payments' },
  ...
  const investorItems = [
    ...
    { to: '/messages', icon: <MessageCircle size={20} />, text: 'Messages' },
    { to: '/notifications', icon: <Bell size={20} />, text: 'Notifications' },
    { to: '/deals', icon: <FileText size={20} />, text: 'Deals & Docs' },
  ];
